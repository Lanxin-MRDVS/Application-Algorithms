...
| Review this application release | [3.0.1 release notes](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/Documentation/depalletizing-release-v3.0.1.md) |
| Deploy the application | [Deployment procedure](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/Documentation/depalletizing-deployment-guide.md) |
| Configure recognition and calibration | [Parameter configuration](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/Documentation/depalletizing-deployment-guide.md) |
| Integrate communication | [Communication protocol](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/Documentation/depalletizing-deployment-guide.md) |
| Interpret results and error codes | [Visual inspection](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/Documentation/depalletizing-deployment-guide.md) |
