...
> **Delivery note:** The current public `3.0.1` download is managed as a standalone Depalletizing package. This guide retains AW3 and AwareSight3 terminology where it describes the documented interface; it does not establish a public AW3 platform release.
