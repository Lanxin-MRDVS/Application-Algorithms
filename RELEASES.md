...
- [Obstacle Avoidance release history](obstacle-avoidance/releases/README.md)
- [AW3 platform release history](aw3/README.md#software-update-history)

This page remains as a stable compatibility link. See the [release policy](user-guides/release-policy.md) for version ownership, required metadata, and publication workflow.
