# <Product or Application> <Version> Release Notes

[Documentation Home](../README.md) / Release Notes

> Copy this file to the owning `releases/` directory as `v<version>.md`. Replace every placeholder. Do not publish while required information remains ambiguous.
...
| Release type | `AW3 platform` / `Application package` / `Tool` |
...
- [User or deployment guide](../docs/)
- [Release history](README.md)
- [Central release index](https://github.com/Lanxin-MRDVS/Application-Algorithms/blob/main/RELEASES.md)
