...
[Documentation Home](../../README.md) / [Applications](../README.md) / Pallet Docking
...
<p align="center">
  ...
  <a href="docs/user-guide.md"><img src="../../assets/button-user-guide-large.svg" alt="Read the Pallet Docking user guide" width="240" height="40"></a>
  <a href="releases/README.md"><img src="../../assets/button-release-history.svg" alt="View Pallet Docking release history" width="240" height="40"></a>
</p>
...
The existing PalletPro release remains available for current deployments. Pallet Docking is planned to move into AW3. When that transition is released, the AW3 platform version will be recorded under `platform/aw3/releases/`, while Pallet Docking-only patches will remain under this application's `releases/` directory and declare AW3 compatibility.
