...
[Documentation Home](../../README.md) / [Obstacle Avoidance](../README.md) / Deployment Guide

> **Delivery note:** This guide describes the current camera-side workflow. The planned Obstacle Avoidance product will use a dedicated host application; no verified public host-application package is recorded yet.
