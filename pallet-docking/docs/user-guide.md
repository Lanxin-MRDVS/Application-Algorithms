...
**[Software Downloads](../README.md#latest-download)** · **[Release Notes](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/PalletPro/pallet-docking-release-v1.4.8_260828.md)**

Figures 4–14 use refreshed English-interface screenshots. Other screenshots and some instructions may reflect earlier software versions. Values displayed in screenshots are examples, not universal defaults. See the [release notes](https://github.com/Lanxin-MRDVS/Application-Algorithms/releases/download/PalletPro/pallet-docking-release-v1.4.8_260828.md) for the revised English terminology in 1.4.8.
